...
export type TExternalSanctumConnectionOption = TAppConnectionOptionBase & {
...
export type TAppConnectionOption =
  ...
  | TExternalSanctumConnectionOption
...
export type TAppConnectionOptionMap = {
  ...
  [AppConnection.ExternalSanctum]: TExternalSanctumConnectionOption;
