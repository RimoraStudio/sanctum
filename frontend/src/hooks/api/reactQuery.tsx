...
export const SIGNUP_TEMP_TOKEN_CACHE_KEY = ["sanctum__signup-temp-token"];
export const MFA_TEMP_TOKEN_CACHE_KEY = ["sanctum__mfa-temp-token"];
export const AUTH_TOKEN_CACHE_KEY = ["sanctum__auth-token"];
