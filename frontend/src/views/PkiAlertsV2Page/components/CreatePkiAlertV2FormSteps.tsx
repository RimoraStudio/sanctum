                          ...
                          <Controller
                            ...
                            render={({ field: secretField }) => (
                              <FormControl
                                ...
                                tooltipText={`Adding a signing secret enables webhook signature verification, helping ensure requests are genuinely from ${envConfig.PLATFORM_NAME}. The signature is sent via the x-sanctum-signature header.`}
                              >
                                <Input
                                  type="password"
