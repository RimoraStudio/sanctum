...
import {
  ExternalSanctumConnectionMethod,
...
type Props = {
  appConnection?: TExternalSanctumConnection;
...
export const ExternalSanctumConnectionForm = ({ appConnection, onSubmit }: Props) => {
    ...
    <FormProvider {...form}>
      <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Field className="mb-4">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-sm">
                    {`The method you would like to use to connect with ${
                      APP_CONNECTION_MAP[AppConnection.ExternalSanctum].name
              ...
              <Select disabled={isUpdate} value={value} onValueChange={(val) => onChange(val)}>
                ...
                <SelectContent position="popper">
                  {Object.values(ExternalSanctumConnectionMethod).map((method) => {
                    return (
            ...
            <Field className="mb-4">
              <FieldLabel htmlFor="instance-url">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-sm">
                    The base URL of the external {envConfig.PLATFORM_NAME} instance (e.g.,
                    https://app.sanctum.com)
                  </TooltipContent>
                </Tooltip>
              </FieldLabel>
              <Input
                ...
                placeholder="https://app.sanctum.com"
              ...
              <FieldLabel htmlFor="machine-identity-client-id">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-sm">
                    ...
                    external {envConfig.PLATFORM_NAME} instance
                  </TooltipContent>
                </Tooltip>
              </FieldLabel>
              <Input
        ...
        <AppConnectionFormFooter
          submitLabel={isUpdate ? "Update Credentials" : `Connect to ${envConfig.PLATFORM_NAME}`}
        />
      </form>
    </FormProvider>
  );
