                  ...
                  <FieldLabel>
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-sm">
                        How often {envConfig.PLATFORM_NAME} will rotate the credentials of this connection.
                      </TooltipContent>
                    </Tooltip>
                  </FieldLabel>
                  <Input
                  ...
                  <Field className="flex-1">
                    <FieldLabel>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-sm">
                          The time of day at which {envConfig.PLATFORM_NAME} will rotate the credentials of this
                          connection.
                        </TooltipContent>
                      </Tooltip>
                    </FieldLabel>
