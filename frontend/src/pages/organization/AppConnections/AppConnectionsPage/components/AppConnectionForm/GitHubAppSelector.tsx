...
const GITHUB_APP_NAME_PREFIX = "sanctum-";
...
type Props = {
  ...
  // selected. Surfaced in the create view so the user knows how Sanctum reaches GitHub.
      ...
      return (
        <div key={app.id} className="m-1 rounded-md border border-danger/40 bg-danger/5 p-3">
          ...
          <p className="mt-1 text-xs leading-relaxed text-accent">
            Removes it from {envConfig.PLATFORM_NAME} and uninstalls it from GitHub. The app registration itself
