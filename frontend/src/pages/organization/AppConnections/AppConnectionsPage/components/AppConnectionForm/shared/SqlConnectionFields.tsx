              ...
              <Field className={sslEnabled ? undefined : "opacity-50"}>
                <Field orientation="horizontal">
                  <FieldContent>
                    ...
                    <FieldDescription>
                      If enabled, {envConfig.PLATFORM_NAME} will only connect to the server if it has a valid,
            ...
            <Field>
              <Field orientation="horizontal">
                <FieldContent>
                  ...
                  <FieldDescription>
                    If enabled, {envConfig.PLATFORM_NAME} will manage the credentials of this App Connection by
