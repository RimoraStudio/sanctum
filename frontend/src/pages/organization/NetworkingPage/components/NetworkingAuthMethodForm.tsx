...
const schema = z
  .object({
    ...
    // Empty string means "no proxy": review straight from Sanctum. Only one may be set.
    gatewayId: z.string(),
                ...
                <FieldLabel className="inline-flex items-center gap-1.5">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-md">
                      ...
                      server {envConfig.PLATFORM_NAME} cannot reach. It must be a different gateway that is already
                  ...
                  <FieldLabel className="inline-flex items-center gap-1.5">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-md">
                        ...
                        {envConfig.PLATFORM_NAME} do it, tunnelling through the gateway to the host below.
                      </TooltipContent>
                    </Tooltip>
                  </FieldLabel>
                  <FieldContent>
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-md">
                        <div className="flex flex-col gap-1">
                          ...
                          <p>
                            Must be reachable from {envConfig.PLATFORM_NAME}, which reviews the token on each login.
                          </p>
                        </div>
                      </TooltipContent>
                    </Tooltip>
                ...
                >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-md">
                      ...
                      authenticate with {envConfig.PLATFORM_NAME}. Leave empty to allow any audience claim.
                    </TooltipContent>
                  </Tooltip>
                </FieldLabel>
                <FieldContent>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent className="max-w-md">
                            <div className="flex flex-col gap-2">
                              <p>
                                When enabled, {envConfig.PLATFORM_NAME} validates the Kubernetes API server&apos;s
