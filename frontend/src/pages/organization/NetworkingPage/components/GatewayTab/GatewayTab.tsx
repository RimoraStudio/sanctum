    ...
    return (
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            {activeSubTab === "gateway-pools"
              ...
              : `Create and manage gateways that securely proxy ${envConfig.PLATFORM_NAME} traffic into your infrastructure`}
          </CardDescription>
          <CardAction>
        ...
        <UpgradePlanModal
          ...
          text={`Your current plan does not include access to gateway pools. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`}
          isEnterpriseFeature
        />
      </Card>
    );
