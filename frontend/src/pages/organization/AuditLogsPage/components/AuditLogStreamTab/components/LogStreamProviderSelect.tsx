  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <UpgradePlanModal
        ...
        text={`Your current plan does not include access to this audit log stream provider. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`}
