              ...
              <FieldLabel htmlFor="cribl-url">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-sm">
                    ...
                    {envConfig.PLATFORM_NAME} HTTP data source port (e.g. 20000), and HTTP event API path (e.g.
                    /sanctum).
                    <br />
                    <br />
                    If your {envConfig.PLATFORM_NAME} Data Source has TLS enabled, then use the https protocol.
                  </TooltipContent>
                </Tooltip>
              </FieldLabel>
              <Input
                id="cribl-url"
                {...field}
                placeholder="http://default.main.example.cribl.cloud:20000/sanctum/_bulk"
