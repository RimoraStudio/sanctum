  ...
  return (
    <div className="mx-auto flex max-w-8xl flex-col">
      ...
      <UpgradePlanModal
        ...
        text={`Your current plan does not include access to ${popUp.upgradePlan.data?.featureName}. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} ${popUp.upgradePlan.data?.isEnterpriseFeature ? "Enterprise" : "Pro"} plan.`}
