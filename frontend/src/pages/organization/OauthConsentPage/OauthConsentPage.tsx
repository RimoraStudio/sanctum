    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-bunker-800">
      ...
      <Card className="w-full max-w-md">
        <Link to="/" className="block">
          <img src="/images/gradientLogo.svg" className="mx-auto h-16" alt={`${envConfig.PLATFORM_NAME} logo`} />
        </Link>

        <CardHeader className="text-center">
          <CardTitle className="justify-center">Authorize Application</CardTitle>
          <CardDescription>
            An external application is requesting access to your {envConfig.PLATFORM_NAME} account.
          </CardDescription>
        </CardHeader>
            ...
            <div className="rounded-md border border-border bg-container p-4">
              ...
              <p className="mt-3 text-xs text-muted">
                {authorizeInfo.requestedScopes.length
                  ? `This application is requesting the following access on your behalf, limited to your existing ${envConfig.PLATFORM_NAME} permissions, until you revoke its session.`
                  : `This application will be able to act on your behalf with your existing ${envConfig.PLATFORM_NAME} permissions until you revoke its session.`}
              </p>
