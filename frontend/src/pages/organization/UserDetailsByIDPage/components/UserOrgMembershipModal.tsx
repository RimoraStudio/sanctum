  ...
  const onFormSubmit = async ({ role, metadata }: FormData) => {
    ...
    if (isCustomOrgRole(role.slug) && subscription && !subscription?.rbac) {
      handlePopUpOpen("upgradePlan", {
        text: `Your current plan does not include access to assigning custom roles to members. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`,
