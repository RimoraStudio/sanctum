...
export const IntegrationsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{envConfig.PLATFORM_NAME} | Integrations</title>
      ...
      <div className="flex w-full justify-center bg-bunker-800 text-white">
        <div className="w-full max-w-8xl">
          <PageHeader
            ...
            title="Integrations"
            description={`Connect ${envConfig.PLATFORM_NAME} to external services and manage organization-wide integrations.`}
          />
