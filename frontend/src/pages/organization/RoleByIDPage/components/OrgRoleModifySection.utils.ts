...
export const ORG_PERMISSION_OBJECT: Record<string, TOrgPermissionConfig> = {
  ...
  [OrgPermissionSubjects.GithubOrgSync]: {
    ...
    description: `Sync GitHub organization teams with ${envConfig.PLATFORM_NAME} groups`,
    actions: [
      {
        value: OrgPermissionActions.Read,
        label: "View",
  ...
  [OrgPermissionSubjects.Gateway]: {
    title: "Gateways",
    description: `Manage gateways that securely connect ${envConfig.PLATFORM_NAME} to your infrastructure`,
    actions: [
      {
      ...
      },
      {
        ...
        description:
          `Register new gateways that securely proxy ${envConfig.PLATFORM_NAME} traffic into your infrastructure`
      },
      {
  ...
  [OrgPermissionSubjects.KmipServer]: {
    title: "KMIP Servers",
    description: `Manage KMIP servers that proxy KMIP requests to ${envConfig.PLATFORM_NAME} KMS`,
    actions: [
      {
