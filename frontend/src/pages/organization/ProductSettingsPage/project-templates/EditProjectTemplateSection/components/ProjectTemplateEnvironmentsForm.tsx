          ...
          {!isSanctumTemplate && (
            <CardAction className="flex items-center gap-2">
              ...
              <OrgPermissionCan
                ...
                allowedLabel={`Plan environment limit of ${subscription.environmentLimit} exceeded. Contact ${envConfig.PLATFORM_NAME} to increase limit.`}
              >
                {(isAllowed) => (
                  <Button
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  {!isSanctumTemplate && <TableHead className="h-12 w-44 px-5" />}
                </TableRow>
              </TableHeader>
              <TableBody>
