...
const CF_TEMPLATE_URL =
  "https://sanctum-static-assets.s3.us-east-1.amazonaws.com/honey-tokens/honey-tokens-v1.yaml";

const DEFAULT_STACK_NAME = "sanctum-honey-tokens";
      ...
      <SheetContent className="sm:max-w-2xl">
        ...
        >
          <SheetHeader>
            ...
            <SheetDescription>
              Plant a decoy IAM credential in your AWS account. {envConfig.PLATFORM_NAME} alerts on every access
              attempt.
            </SheetDescription>
          </SheetHeader>
            ...
            {hasSavedConfig && (
              <div className="mt-4 rounded-md border border-border bg-container p-4">
                ...
                <p className="mb-3 text-sm text-mineshaft-400">
                  ...
                  user and wires CloudTrail alerts back to {envConfig.PLATFORM_NAME}.
                </p>
