...
export const SecretInsightsPage = withPermission(
  () => {
    ...
    return (
      <>
        <Helmet>
          <title>Secret Insights | {envConfig.PLATFORM_NAME}</title>
        ...
        <UpgradePlanModal
          ...
          text={`Your current plan does not include access to secret insights. To unlock this feature, please upgrade your ${envConfig.PLATFORM_NAME} plan.`}
        />
      </>
    );
  },
