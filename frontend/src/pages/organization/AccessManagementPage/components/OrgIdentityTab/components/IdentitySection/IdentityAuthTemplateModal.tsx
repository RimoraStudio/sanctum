                ...
                <Controller
                  ...
                  render={({ field, fieldState: { error } }) =>
                    renderField("identity-auth-template-bind-dn", "Bind DN", field, error, {
                      placeholder: "cn=sanctum,ou=Users,dc=example,dc=com"
                    })
                  }
                />
                                ...
                                <Tooltip>
                                  ...
                                  <TooltipContent className="max-w-md">
                                    {hasCaCert
                                      ...
                                      : `When enabled, ${envConfig.PLATFORM_NAME} validates the Kubernetes API server's TLS certificate against the CA certificate provided below.`}
                                  </TooltipContent>
                                </Tooltip>
                              </FieldLabel>
                            </div>
