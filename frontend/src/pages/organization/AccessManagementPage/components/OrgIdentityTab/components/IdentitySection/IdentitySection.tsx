                    ...
                    onClick={() => {
                      if (subscription && !subscription.machineIdentityAuthTemplates) {
                        handlePopUpOpen("upgradePlan", {
                          ...
                          text: `Your current plan does not include access to creating Machine Identity Auth Templates. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`
                        });
                        return;
                      }
