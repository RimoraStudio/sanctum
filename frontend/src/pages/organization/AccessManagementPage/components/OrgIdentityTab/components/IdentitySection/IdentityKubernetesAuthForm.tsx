                      ...
                      <TooltipContent className="max-w-md">
                        <div className="flex flex-col gap-1">
                          <p>
                            ...
                            belong to authenticate with {envConfig.PLATFORM_NAME}.
                          </p>
                          <p>
                      ...
                      <TooltipContent className="max-w-md">
                        <div className="flex flex-col gap-1">
                          <p>
                            ...
                            are allowed to authenticate with {envConfig.PLATFORM_NAME}. Leave empty to allow any
                            service account.
                          </p>
                          <p>
                            Regex and Wildcard patterns are supported. Use{" "}
                              ...
                              <TooltipContent className="max-w-md">
                                <div className="flex flex-col gap-2">
                                  {hasCaCert ? (
                                    ...
                                    <>
                                      <p>
                                        When enabled, {envConfig.PLATFORM_NAME} validates the Kubernetes API
