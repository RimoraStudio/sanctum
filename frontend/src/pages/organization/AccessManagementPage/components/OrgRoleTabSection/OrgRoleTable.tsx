  ...
  const handleSetRoleAsDefault = async (defaultMembershipRoleSlug: string) => {
    ...
    if (isCustomRole && subscription && !subscription?.rbac) {
      handlePopUpOpen("upgradePlan", {
        text: `Your current plan does not include access to set a custom default organization role. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`,
    ...
    <>
      ...
      {isProPlan && customRoles?.length > 0 && (
        <Alert variant="warning" className="mb-4">
          ...
          <AlertDescription>
            <div>
              Custom roles are part of the {envConfig.PLATFORM_NAME} Enterprise plan, but were temporarily available
              to Pro users. Creation of new roles will be enforced starting June 1, 2026.
              <br />
              Please{" "}
              <a
                href="https://sanctum.com/scheduledemo"
                target="_blank"
