...
const MAPPING_TYPE_MENU_ITEMS = [
  {
    ...
    tooltip: (
      <div>
        When using key vaults for mapping, each key vault within Vault will be created in {envConfig.PLATFORM_NAME}
  ...
  },
  {
    ...
    tooltip: (
      <div>
        When using namespaces for mapping, each namespace within Vault will be created in {envConfig.PLATFORM_NAME}
