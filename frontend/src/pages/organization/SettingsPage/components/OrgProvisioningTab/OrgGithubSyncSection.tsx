  ...
  return (
    <>
      ...
      <UpgradePlanModal
        ...
        text={`Your current plan does not include access to GitHub Organization Sync. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`}
