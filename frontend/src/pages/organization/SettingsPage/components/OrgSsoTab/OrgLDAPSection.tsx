  ...
  return (
    <>
          ...
          <FieldGroup>
            {data && (
              <Field orientation="horizontal">
                <FieldContent>
                  ...
                  <FieldDescription>
                    Allow members to authenticate into {envConfig.PLATFORM_NAME} with LDAP.
                  </FieldDescription>
                </FieldContent>
                <OrgPermissionCan
            ...
            <Field orientation="horizontal">
              <FieldContent>
                ...
                <FieldDescription>
                  Manage how LDAP groups are mapped to internal groups in {envConfig.PLATFORM_NAME}.
                </FieldDescription>
              </FieldContent>
              <OrgPermissionCan I={OrgPermissionActions.Create} a={OrgPermissionSubjects.Ldap}>
                {(isAllowed) => (
      ...
      <UpgradePlanModal
        ...
        text={`Your current plan does not include access to LDAP authentication. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`}
