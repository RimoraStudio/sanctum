          ...
          <div className="flex h-full min-h-0 flex-col">
            ...
            <div className="thin-scrollbar flex-1 overflow-y-auto px-4 py-4">
                    ...
                    <div className="flex items-end gap-3">
                      ...
                      <Controller
                        ...
                        render={({ field: { onChange, value }, fieldState: { error } }) => (
                          <Field className="flex-1">
                            <FieldLabel htmlFor="ldap-group-slug">{envConfig.PLATFORM_NAME} Group</FieldLabel>
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead>{envConfig.PLATFORM_NAME} Group</TableHead>
                  ...
                  {!isPending && groupMaps?.length === 0 && (
                    <Empty className="border">
                      <EmptyHeader>
                        ...
                        <EmptyDescription>
                          Add a mapping above to assign LDAP groups to {envConfig.PLATFORM_NAME} groups.
                        </EmptyDescription>
                      </EmptyHeader>
                    </Empty>
                  )}
              ...
              {groups && groups.length === 0 && (
                <Empty className="border">
                  <EmptyHeader>
                    <EmptyTitle>No {envConfig.PLATFORM_NAME} groups</EmptyTitle>
                    <EmptyDescription>
                      Create an {envConfig.PLATFORM_NAME} group in your organization before mapping LDAP groups.
                    </EmptyDescription>
                    <EmptyContent>
                      <Button
                        variant="org"
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Members of this LDAP group will no longer be added to the mapped {envConfig.PLATFORM_NAME} group.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
