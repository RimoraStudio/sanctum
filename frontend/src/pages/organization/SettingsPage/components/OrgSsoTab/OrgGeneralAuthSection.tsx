  ...
  return (
    <>
      ...
      <UpgradePlanModal
        ...
        text={`Your current plan does not include access to ${popUp.upgradePlan.data?.featureName ?? "enforce SAML SSO"}. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} ${popUp.upgradePlan.data?.isEnterpriseFeature ? "Enterprise" : "Pro"} plan.`}
