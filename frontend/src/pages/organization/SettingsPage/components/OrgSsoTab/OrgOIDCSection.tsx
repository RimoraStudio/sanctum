  ...
  return (
    <>
          ...
          <FieldGroup>
            ...
            {data && (
              <Field orientation="horizontal">
                <FieldContent>
                  ...
                  <FieldDescription>
                    Allow members to authenticate into {envConfig.PLATFORM_NAME} with OIDC.
                  </FieldDescription>
                </FieldContent>
                {!isPending && (
                  <OrgPermissionCan
            ...
            <Field orientation="horizontal">
              <FieldContent>
                ...
                <FieldDescription>
                  {envConfig.PLATFORM_NAME} will manage user group memberships based on the OIDC provider.
                </FieldDescription>
              </FieldContent>
      ...
      <UpgradePlanModal
        ...
        text={`Your current plan does not include access to OIDC SSO. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`}
        isEnterpriseFeature
      />
    </>
  );
