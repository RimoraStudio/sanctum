    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Register external platforms to request delegated access to {envConfig.PLATFORM_NAME} on a user&apos;s
              ...
              {!isPending && filteredClients.length === 0 ? (
                <Empty className="border">
                  <EmptyHeader>
                    ...
                    <EmptyDescription>
                      Add an application to let an external platform access {envConfig.PLATFORM_NAME} on a
      ...
      <DeleteConfirmDialog
        ...
        description={`External platforms using this application will no longer be able to access ${envConfig.PLATFORM_NAME} on a user's behalf, and existing tokens will be revoked.`}
