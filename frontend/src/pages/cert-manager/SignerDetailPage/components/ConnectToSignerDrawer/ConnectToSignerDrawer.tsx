      ...
      return (
        <>
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted">
            ...
            Windows. Either way, the private key stays in {envConfig.PLATFORM_NAME}.
          </p>
        </>
      );
    }
    if (step === 2) {
      return (
        <>
          <p className="mt-4 text-sm font-semibold text-foreground">What this step does</p>
          <p className="mt-2 text-sm leading-relaxed text-muted">
            Choose how the signing machine logs in to {envConfig.PLATFORM_NAME}.{" "}
          ...
          <div className="flex min-w-0 flex-1 flex-col overflow-y-auto px-8 py-6">
            {step === 1 && (
              <>
                ...
                <p className="mt-1 mb-6 text-sm text-muted">
                  Pick the tool you already sign with. {envConfig.PLATFORM_NAME} plugs into it, so your build keeps
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <MethodCard
                    ...
                    description={`jarsigner, osslsigncode, cosign, and other common tools. Uses the ${envConfig.PLATFORM_NAME} PKCS#11 module.`}
                  ...
                  <MethodCard
                    ...
                    description={`Native Windows Authenticode signing with Microsoft signtool. Uses the ${envConfig.PLATFORM_NAME} Key Storage Provider.`}
                    platforms={["Windows"]}
            ...
            {step === 2 && (
              <>
                ...
                <p className="mt-1 mb-6 text-sm text-muted">
                  Pick how the signing tool proves who it is to {envConfig.PLATFORM_NAME} during signing operations.
                </p>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <AuthOptionCard
                    icon={<KeyRoundIcon className="size-4" />}
                    title="Use my credentials"
                    description={`Sign as yourself with your own ${envConfig.PLATFORM_NAME} access token. Quickest to set up, but temporary because the token expires.`}
            ...
            {step === 3 && (
              <>
                ...
                <p className="mt-1 mb-6 text-sm text-muted">
                  {method === Method.Ksp
                    ? `Install the ${envConfig.PLATFORM_NAME} Key Storage Provider, then sign with Microsoft signtool.`
                    : `Install the ${envConfig.PLATFORM_NAME} PKCS#11 module, then sign with jarsigner, osslsigncode, or any PKCS#11 tool.`}
                </p>
                ...
                {method === Method.Ksp ? (
                  <div className="space-y-5">
                    ...
                    <SubStep
                      ...
                      description={
                        authMethod === AuthMethod.Token
                          ? `Set your ${envConfig.PLATFORM_NAME} address and access token as environment variables.`
                          : `Set your ${envConfig.PLATFORM_NAME} address and Machine Identity credentials as environment variables.`
                      }
                    >
                  ...
                  <div className="space-y-5">
                    <SubStep
                      ...
                      description="Download and extract the module for your platform from the GitHub releases page. It unpacks to libsanctum-pkcs11-<os>-<arch>; use that path wherever a module path is needed below."
                    >
