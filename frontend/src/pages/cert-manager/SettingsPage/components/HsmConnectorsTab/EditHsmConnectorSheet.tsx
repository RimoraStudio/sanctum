                  ...
                  render={({ field, fieldState: { error } }) => (
                    <Field>
                      ...
                      <FieldContent>
                        ...
                        />
                        <FieldDescription>
                          The {envConfig.PLATFORM_NAME} Gateway (or pool) that will reach the HSM over PKCS#11.
                        </FieldDescription>
                        <FieldError errors={[error]} />
                      </FieldContent>
                    </Field>
                  ...
                  render={({ field, fieldState: { error } }) => (
                    <Field>
                      ...
                      <FieldContent>
                        ...
                        <FieldDescription>
                          Prepended to the label of every key {envConfig.PLATFORM_NAME} creates on this HSM.
                        </FieldDescription>
                        <FieldError errors={[error]} />
                      </FieldContent>
                    </Field>
                  ...
                  render={({ field, fieldState: { error } }) => (
                    <Field>
                      ...
                      <FieldContent>
                        ...
                        <FieldDescription>
                          {routingChanged
                            ? `Required because you are changing the Gateway. Re-enter the PIN so ${envConfig.PLATFORM_NAME} can verify it against the new route.`
            ...
            <aside className="hidden w-80 shrink-0 flex-col gap-4 overflow-y-auto border-l border-border px-6 py-6 lg:flex">
              <div className="mb-auto">
                ...
                <div className="mt-6 rounded-md border border-border bg-mineshaft-800 p-3 text-xs text-muted">
                  If you change the PIN, slot, or Gateway, {envConfig.PLATFORM_NAME} re-runs a Verify against the
