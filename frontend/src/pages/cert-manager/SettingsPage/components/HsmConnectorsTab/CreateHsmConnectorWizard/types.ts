...
export const STEPS: WizardStep[] = [
  ...
  },
  {
    ...
    title: "Connection",
    subtitle: `Choose the Gateway that connects ${envConfig.PLATFORM_NAME} to your HSM.`,
  ...
  },
  {
    ...
    title: "Credentials",
    subtitle: `How ${envConfig.PLATFORM_NAME} signs in to your HSM.`,
    rightLabel: "CREDENTIALS",
    rightDescription:
      `The slot label is the PKCS#11 token label of the slot ${envConfig.PLATFORM_NAME} will use on the HSM. The PIN authenticates ${envConfig.PLATFORM_NAME} to that slot. The key label prefix is prepended to every key ${envConfig.PLATFORM_NAME} creates so you can identify them in your HSM tooling.`
  }
];
