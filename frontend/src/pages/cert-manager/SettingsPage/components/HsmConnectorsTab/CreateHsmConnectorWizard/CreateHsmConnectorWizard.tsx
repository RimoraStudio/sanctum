...
export const CreateHsmConnectorWizard = ({ isOpen, onOpenChange }: Props) => {
  ...
  const reset = () => {
    ...
    accessForm.reset({ slotLabel: "", pin: "", keyNamePrefix: "sanctum-" });
  };
            ...
            <div className="flex w-full items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm leading-4 text-mineshaft-400">
                  Register a hardware security module so {envConfig.PLATFORM_NAME} can route key operations through
                  it.
                </p>
              </div>
            </div>
              ...
              <div className="mt-auto space-y-3">
                {isLast && (
                  <p className="text-xs leading-relaxed text-muted">
                    {envConfig.PLATFORM_NAME} runs a Verify against your HSM before saving. A wrong PIN, slot, or
