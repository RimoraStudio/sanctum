      ...
      <div>
        <div className="rounded-md border border-yellow-500/30 bg-yellow-500/5 p-8 text-center">
          ...
          <p className="mx-auto mb-4 max-w-md text-sm text-mineshaft-300">
            HSM Connectors let {envConfig.PLATFORM_NAME} use keys backed by a Hardware Security Module. Every
        ...
        <UpgradePlanModal
          ...
          text={`To use HSM Connectors, upgrade to ${envConfig.PLATFORM_NAME}'s Enterprise plan.`}
        />
      </div>
    );
  }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Connect hardware security modules to {envConfig.PLATFORM_NAME}.</CardDescription>
        <CardAction>
