              ...
              >
                <Tooltip>
                  ...
                  <TooltipContent
                    side="left"
                    sideOffset={20}
                  >{`Import certificates from this ${destinationName} destination into ${envConfig.PLATFORM_NAME}.`}</TooltipContent>
                </Tooltip>
              </DropdownMenuItem>
            )}
              ...
              >
                <Tooltip>
                  ...
                  <TooltipContent
                    side="left"
                    sideOffset={20}
                  >{`Remove certificates synced by ${envConfig.PLATFORM_NAME} from this ${destinationName} destination.`}</TooltipContent>
                </Tooltip>
              </DropdownMenuItem>
            )}
            <DropdownMenuItem
