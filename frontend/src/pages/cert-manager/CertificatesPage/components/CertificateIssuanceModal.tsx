...
const STEP_META: Record<IssuanceStepKey, WizardStep> = {
  profile: {
    ...
    rightLabel: "Profile",
    rightDescription:
      `The certificate profile determines the issuing CA and the policy that constrains what this certificate may contain. Choose Managed to have ${envConfig.PLATFORM_NAME} generate the key pair for you, or CSR to supply your own certificate signing request.`
  },
  csr: {
