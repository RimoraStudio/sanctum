            ...
            <FieldContent>
              ...
              >
                ...
                <SelectContent position="popper">
                  <SelectItem value={CertKeySource.Sanctum}>{envConfig.PLATFORM_NAME}</SelectItem>
              ...
              <FieldDescription>
                {isHsm
                  ...
                  : `${envConfig.PLATFORM_NAME} generates and manages the CA keypair for you.`}
              </FieldDescription>
            </FieldContent>
          </Field>
        )}
          ...
          render={({ field, fieldState: { error } }) => (
            <Field>
              ...
              <FieldContent>
                ...
                />
                <FieldDescription>
                  The HSM on which {envConfig.PLATFORM_NAME} will generate the CA signing key.
                </FieldDescription>
