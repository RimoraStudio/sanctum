...
const UNCHANGED_CREDENTIAL_SENTINEL = "__SANCTUM_UNCHANGED__";
        ...
        <SheetHeader className="border-b border-border">
          {showGrid ? (
            <>
              ...
              <SheetDescription>
                Select the third-party certificate authority to connect to. {envConfig.PLATFORM_NAME} issues through
