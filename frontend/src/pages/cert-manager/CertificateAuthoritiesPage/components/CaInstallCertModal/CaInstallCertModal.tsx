...
const SIGNING_METHOD_OPTIONS: TSigningMethodOption[] = [
  {
    ...
    name: `${envConfig.PLATFORM_NAME} CA`,
    description:
      `Sign with an internal ${envConfig.PLATFORM_NAME} root or intermediate CA. Fully managed, no external setup needed.`,
  ...
  },
  {
    ...
    description:
      `Connect to a third-party CA provider. ${envConfig.PLATFORM_NAME} automatically handles certificate signing and renewal through the provider's API.`,
    icon: LinkIcon
  }
];
