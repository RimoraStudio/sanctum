    ...
    <>
      <Card className="gap-0 overflow-hidden border-danger/25 p-0">
        <CardHeader className="p-6">
          ...
          <CardDescription>
            Permanently delete your account and revoke its access to {envConfig.PLATFORM_NAME}. This cannot be
            undone.
          </CardDescription>
        </CardHeader>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Your account will permanently lose access to {envConfig.PLATFORM_NAME}. This cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <Field>
