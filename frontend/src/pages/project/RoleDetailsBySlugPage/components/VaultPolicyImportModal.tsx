...
import { parseVaultPolicyToSanctum } from "./VaultPolicyImportModal.utils";
...
const Content = ({ onClose, appConnections }: ContentProps) => {
  ...
  const handleTranslateAndApply = () => {
    ...
    try {
      const parsedPermissions = parseVaultPolicyToSanctum(hclPolicy, mounts);
          ...
          <AlertDescription>
            <div className="space-y-1.5">
              ...
              <p>
                ...
                automatically mapped to equivalent {envConfig.PLATFORM_NAME} permissions and glob patterns.
              </p>
            </div>
          </AlertDescription>
        </Alert>
      ...
      <SheetContent className="w-[calc(100vw-2rem)] sm:max-w-5xl">
        <SheetHeader>
          ...
          <SheetDescription>
            ...
            into {envConfig.PLATFORM_NAME} permissions.
          </SheetDescription>
        </SheetHeader>
