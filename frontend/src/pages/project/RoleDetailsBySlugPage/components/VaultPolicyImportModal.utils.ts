...
/**
 * Maps Vault capabilities to Sanctum secret actions.
 *
 * Mapping:
 * - create → Create
...
/**
 * Maps Vault capabilities to Sanctum folder actions.
 *
 * Mapping:
 * - create → Create
 * - update/patch → Edit
...
/**
 * Converts Vault wildcard patterns to Sanctum glob patterns.
...
/**
 * Parses Vault HCL policy and converts it to Sanctum permissions.
 *
 * Process:
 ...
 *    - Map Vault capabilities to Sanctum actions
 ...
 * @returns Parsed permissions object ready for Sanctum role creation
 */
export const parseVaultPolicyToSanctum = (
  hclPolicy: string,
  mounts: VaultMount[]
