  ...
  return (
    <AuthPageLayout variant="focused">
      <Helmet>
        ...
        <meta property="og:title" content={`Account Recovery in ${envConfig.PLATFORM_NAME}`} />
        <meta
          name="og:description"
          content={`${envConfig.PLATFORM_NAME} a simple end-to-end encrypted platform that enables teams to sync and manage their .env files.`}
        />
      </Helmet>
