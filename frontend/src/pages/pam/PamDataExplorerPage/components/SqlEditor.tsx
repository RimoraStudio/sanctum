...
const sanctumTheme = EditorView.theme({
  ...
  ".cm-content": { padding: "8px 0", caretColor: "#c3ccd8", backgroundColor: "#16181a" },
  ...
  ".cm-cursor": { borderLeftColor: "#c3ccd8" },
  ...
  ".cm-matchingBracket": { backgroundColor: "#323439", color: "#c3ccd8 !important" }
});

const sanctumHighlight = HighlightStyle.define(
  [
    ...
    const view = new EditorView({
      state: EditorState.create({
        ...
        extensions: [
          ...
          sanctumTheme,
          syntaxHighlighting(sanctumHighlight),
