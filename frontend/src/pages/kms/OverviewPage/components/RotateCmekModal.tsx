...
export const RotateCmekModal = ({ isOpen, onOpenChange, cmek }: Props) => {
  ...
  return (
    <DeleteActionModal
      ...
      formContent={
        <NoticeBannerV2 title={`Data encrypted outside ${envConfig.PLATFORM_NAME} may be affected`} className="mb-4">
          <p className="text-sm text-mineshaft-300">
            Data encrypted through {envConfig.PLATFORM_NAME} stays decryptable. However, any system that holds this
