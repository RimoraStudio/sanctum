  ...
  const onSubmit = useCallback(async (formData: TForm) => {
    ...
    if (!subscription.hsm) {
      handlePopUpOpen("upgradePlan", {
        ...
        text: `Your current plan does not include access to Hardware Security Module (HSM). To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`
      });
      return;
    }
