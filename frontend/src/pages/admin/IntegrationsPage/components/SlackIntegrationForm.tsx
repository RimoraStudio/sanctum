  ...
  `https://api.slack.com/apps?new_app=1&manifest_json=${encodeURIComponent(
    JSON.stringify({
      display_information: {
        ...
        description: `Get real-time ${envConfig.PLATFORM_NAME} updates in Slack`,
        background_color: "#74839a",
        long_description: `This Slack application is designed specifically for use with your self-hosted ${envConfig.PLATFORM_NAME} instance, allowing seamless integration between your ${envConfig.PLATFORM_NAME} projects and your Slack workspace. With this integration, your team can stay up-to-date with the latest events, changes, and notifications directly inside Slack.
        - Notifications: Receive real-time updates and alerts about critical events in your ${envConfig.PLATFORM_NAME} projects. Whether it's a new project being created, updates to secrets, or changes to your team's configuration, you will be promptly notified within the designated Slack channels of your choice.
        ...
        - Collaboration: Keep your entire team in the loop with notifications that help facilitate more efficient collaboration by ensuring that everyone is aware of important developments in your ${envConfig.PLATFORM_NAME} projects.

        By integrating ${envConfig.PLATFORM_NAME} with Slack, you can enhance your workflow by combining the power of secure secrets management with the communication capabilities of Slack.`
      },
      features: {
        app_home: {
        ...
        bot_user: {
          display_name: envConfig.PLATFORM_NAME,
          always_online: true
        }
      },
      oauth_config: {
          ...
          <AccordionContent className="p-6">
            <div className="flex w-full flex-col gap-4">
              <div className="max-w-lg text-sm text-label">
                Step 1: Create your {envConfig.PLATFORM_NAME} Slack App
              </div>
              <div>
                <Button
                  variant="neutral"
