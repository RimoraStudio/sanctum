      ...
      <div className="flex min-h-0 flex-1 flex-col space-y-5 overflow-y-auto p-4">
        ...
        <Field>
          <VaultFieldLabel
            ...
            tooltip={`Choose one or more secret paths from the selected mount to import into ${envConfig.PLATFORM_NAME}.`}
          ...
          />
          <FieldDescription>
            Choose one or more secret paths from the selected mount to import into {envConfig.PLATFORM_NAME}
          </FieldDescription>
        </Field>
