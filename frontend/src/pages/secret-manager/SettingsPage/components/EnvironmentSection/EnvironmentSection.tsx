  ...
  return (
    <Card id="environments" className="mb-6 scroll-m-6">
      ...
      <UpgradePlanModal
        ...
        text={`You have reached the maximum number of environments allowed on the free plan. Upgrade to ${envConfig.PLATFORM_NAME} Pro plan to add more environments.`}
      />
    </Card>
  );
};
