...
const BackupConfirmationModal = ({
  ...
  const downloadKmsBackup = async () => {
    ...
    try {
      ...
      FileSaver.saveAs(blob, `kms-backup-${org.slug}-${project.slug}-${kmsFunction}.sanctum.txt`);
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            the project&apos;s KMS back to the default {envConfig.PLATFORM_NAME} KMS.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            By loading a backup, the project&apos;s KMS will be switched to the default {envConfig.PLATFORM_NAME}
            KMS.
          </DialogDescription>
        </DialogHeader>
        <FileDropzone
          accept=".txt"
          description=".sanctum.txt backup file"
          files={backupFiles}
