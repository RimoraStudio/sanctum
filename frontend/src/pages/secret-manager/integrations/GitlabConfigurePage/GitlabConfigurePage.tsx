...
const initialSyncBehaviors = [
  ...
  { label: `Import - Prefer values from ${envConfig.PLATFORM_NAME}`, value: IntegrationSyncBehavior.PREFER_SOURCE }
];
    ...
    >
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle={`Select which environment or folder in ${envConfig.PLATFORM_NAME} you want to sync to GitLab's environment variables.`}
        >
                  ...
                  render={({ field: { onChange, value } }) => (
                    ...
                    >
                      <div className="max-w-md">
                        Mark {envConfig.PLATFORM_NAME} secrets in Gitlab as &apos;Masked&apos; secrets
                      </div>
                    </Switch>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <Switch
                      ...
                      isChecked={value}
                    >
                      Mark {envConfig.PLATFORM_NAME} secrets in Gitlab as &apos;Protected&apos; secrets
                    </Switch>
                  )}
                />
              </div>
              <Controller
                ...
                render={({ field, fieldState: { error } }) => (
                  <FormControl
                    ...
                    errorText={error?.message}
                  >
                    <Input {...field} placeholder="SANCTUM_" />
                  </FormControl>
                )}
              />
              <Controller
                ...
                render={({ field, fieldState: { error } }) => (
                  <FormControl
                    ...
                    errorText={error?.message}
                  >
                    <Input {...field} placeholder="_SANCTUM" />
                  </FormControl>
                )}
              />
            </motion.div>
