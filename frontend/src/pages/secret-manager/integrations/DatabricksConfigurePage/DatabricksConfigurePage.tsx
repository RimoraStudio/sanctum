    ...
    <div className="flex h-full w-full flex-col items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle={`Choose which environment or folder in ${envConfig.PLATFORM_NAME} you want to sync to which Databricks secrets scope.`}
        >
      ...
      <div className="mt-6 flex w-full max-w-lg flex-col rounded-md border border-mineshaft-600 bg-mineshaft-800 p-4">
        ...
        <span className="mt-4 text-sm text-mineshaft-300">
          When integrating with Databricks, {envConfig.PLATFORM_NAME} is intended to be the source of truth for the
          secrets in the configured Databricks scope.
        </span>
        <span className="mt-4 text-sm text-mineshaft-300">
          Any secrets not present in {envConfig.PLATFORM_NAME} will be removed from the specified scope. To prevent
          removal of secrets not managed by {envConfig.PLATFORM_NAME}, {envConfig.PLATFORM_NAME} recommends creating a designated
