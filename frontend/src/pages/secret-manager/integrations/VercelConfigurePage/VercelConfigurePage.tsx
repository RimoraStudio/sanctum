...
const initialSyncBehaviors = [
  ...
  {
    label: `Import - Prefer values from ${envConfig.PLATFORM_NAME}`,
    ...
    <div className="flex h-full w-full flex-col items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600 p-0">
        <CardTitle
          ...
          subTitle={`Select which environment or folder in ${envConfig.PLATFORM_NAME} you want to sync to Vercel's environment variables.`}
        >
          <div className="flex flex-row items-center">
            ...
            <a
              target="_blank"
              href="https://sanctum.com/docs/integrations/cloud/vercel"
        ...
        <FormControl label={`${envConfig.PLATFORM_NAME} Project Environment`} className="px-6">
          <Select
        ...
        <FormControl
          ...
          helperText={
            <Tooltip
              className="max-w-md"
              content={`Double check ${envConfig.PLATFORM_NAME}'s access permissions in Vercel by navigating to Team > Integrations > ${envConfig.PLATFORM_NAME} > Settings > Manage Access.`}
            >
              <div>
      ...
      <div className="mt-6 flex w-full max-w-lg flex-col rounded-md border border-mineshaft-600 bg-mineshaft-800 p-4">
        ...
        <span className="mt-4 text-sm text-mineshaft-300">
          ...
          cause an unexpected override of current secrets in Vercel with secrets from {envConfig.PLATFORM_NAME}.
        </span>
      </div>
    </div>
  ) : (
