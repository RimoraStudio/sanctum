    ...
    <div className="flex h-full w-full items-center justify-center">
      ...
      <Card className="mb-12 max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle={`After adding your access token, you will be prompted to set up an integration for a particular ${envConfig.PLATFORM_NAME} project and environment.`}
        >
