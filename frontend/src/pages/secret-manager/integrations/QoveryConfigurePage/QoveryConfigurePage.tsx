    ...
    <div className="flex h-full w-full flex-col items-center justify-center bg-linear-to-tr from-mineshaft-900 to-bunker-900">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600 p-0">
        <CardTitle
          ...
          subTitle={`Choose which environment in ${envConfig.PLATFORM_NAME} you want to sync to Checkly environment variables.`}
        >
        ...
        <Tabs defaultValue={TabSections.SanctumSettings} className="px-6">
          <TabList>
            <div className="flex w-full flex-row border-b border-mineshaft-600">
              <Tab value={TabSections.SanctumSettings}>{envConfig.PLATFORM_NAME} Settings</Tab>
              <Tab value={TabSections.QoverySettings}>Qovery Settings</Tab>
            </div>
          </TabList>
          <TabPanel value={TabSections.SanctumSettings}>
            <motion.div
              key="panel-1"
            ...
            >
              <FormControl label={`${envConfig.PLATFORM_NAME} Project Environment`}>
                <Select
      ...
      <div className="flex flex-col bg-mineshaft-800 border border-mineshaft-600 w-full p-4 max-w-lg mt-6 rounded-md">
        ...
        <span className="text-mineshaft-300 text-sm mt-4">After creating an integration, your secrets will start syncing immediately. This might cause an unexpected override of current secrets in Qovery with secrets from Sanctum.</span>
      </div> */}
    </div>
  ) : (
        ...
        <div className="flex h-max max-w-md flex-col rounded-md border border-mineshaft-600 bg-mineshaft-800 p-6 text-center text-mineshaft-200">
          ...
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="mailto:support@sanctum.com"
            >
              support@sanctum.com
            </a>{" "}
