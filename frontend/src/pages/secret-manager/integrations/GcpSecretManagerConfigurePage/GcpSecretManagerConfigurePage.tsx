    ...
    >
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        ...
        <CardTitle
          ...
          subTitle={`Select which environment or folder in ${envConfig.PLATFORM_NAME} you want to sync to GCP Secret Manager.`}
        >
          <div className="flex flex-row items-center">
            ...
            <a
              ...
              href="https://sanctum.com/docs/integrations/cloud/gcp-secret-manager"
            >
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState: { error } }) => (
                      <FormControl
                        ...
                        errorText={error?.message}
                      >
                        <Input {...field} placeholder="sanctum" />
                      </FormControl>
                    )}
                  />
                </div>
