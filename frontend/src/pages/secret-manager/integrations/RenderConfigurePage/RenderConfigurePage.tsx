    ...
    >
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle
          ...
          subTitle={`Choose which environment or folder in ${envConfig.PLATFORM_NAME} you want to sync to Render environment variables.`}
        >
      ...
      <div className="mt-6 flex w-full max-w-lg flex-col rounded-md border border-mineshaft-600 bg-mineshaft-800 p-4">
        ...
        <span className="mt-4 text-sm text-mineshaft-300">
          ...
          cause an unexpected override of current secrets in Render with secrets from {envConfig.PLATFORM_NAME}.
        </span>
      </div>
    </form>
  ) : (
