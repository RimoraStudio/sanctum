...
const OverviewPageContent = () => {
  ...
  const handleViewCommitHistory = (envSlug: string) => {
    if (!subscription?.pitRecovery) {
      handlePopUpOpen("upgradePlan", {
        text: `You can use point-in-time recovery if you upgrade your ${envConfig.PLATFORM_NAME} plan.`
      });
      return;
    }
  ...
  const ensureFolderRbacPlan = useCallback(() => {
    ...
    handlePopUpOpen("upgradePlan", {
      text: `Folder-level access controls can be unlocked if you upgrade to ${envConfig.PLATFORM_NAME} Pro plan.`
    });
    return false;
                  ...
                  <AddResourceButtons
                    ...
                    onAddDyanamicSecret={() => {
                      ...
                      handlePopUpOpen("upgradePlan", {
                        ...
                        text: `Upgrade to the ${envConfig.PLATFORM_NAME} Secret Management advanced plan to unlock dynamic secrets.`
                      });
                    }}
                    onAddSecretRotation={() => {
                      ...
                      handlePopUpOpen("upgradePlan", {
                        text: `Adding secret rotations can be unlocked if you upgrade to ${envConfig.PLATFORM_NAME} Pro plan.`
                      });
                    }}
                    onAddHoneyToken={async () => {
                      ...
                      handlePopUpOpen("upgradePlan", {
                        text: `Adding honey tokens can be unlocked if you upgrade to ${envConfig.PLATFORM_NAME} Pro plan.`
                      });
                    }}
                    onAddProxiedService={() => {
                      ...
                      handlePopUpOpen("upgradePlan", {
                        isEnterpriseFeature: true,
                        text: `Secrets brokering can be unlocked if you upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`
                      });
                    }}
              ...
              <EmptyResourceDisplay
                ...
                onAddEnvironment={() => {
                  if (isMoreEnvironmentsAllowed) {
                    ...
                    handlePopUpOpen("upgradePlan", {
                      text: `Your current plan does not include access to adding custom environments. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Pro plan.`
                    });
                  }
                }}
              />
