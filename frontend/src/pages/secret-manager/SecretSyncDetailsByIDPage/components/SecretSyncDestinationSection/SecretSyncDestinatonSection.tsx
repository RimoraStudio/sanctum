...
import { ExternalSanctumSyncDestinationSection } from "./ExternalSanctumSyncDestinationSection";
...
export const SecretSyncDestinationSection = ({ secretSync }: Props) => {
  ...
  switch (destination) {
    ...
    case SecretSync.ExternalSanctum:
      DestinationComponents = <ExternalSanctumSyncDestinationSection secretSync={secretSync} />;
      break;
    case SecretSync.OVH:
