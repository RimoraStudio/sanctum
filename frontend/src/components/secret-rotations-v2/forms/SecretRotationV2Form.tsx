...
const FORM_STEPS: FormStep[] = [
  {
    ...
    subtitle: `Choose the connection and decide when ${envConfig.PLATFORM_NAME} should rotate these credentials.`,
    rightLabel: "Configuration",
    rightDescription:
      `The connection identifies the provider account. The schedule controls how often ${envConfig.PLATFORM_NAME} replaces its active credentials.`,
    fields: [
  ...
  },
  {
    ...
    rightDescription:
      `These settings are specific to the selected provider and determine which account or resource ${envConfig.PLATFORM_NAME} manages.`,
  ...
  },
  {
    ...
    subtitle: `Choose the ${envConfig.PLATFORM_NAME} secret keys that will receive each generated credential.`,
    rightLabel: "Mappings",
    rightDescription:
