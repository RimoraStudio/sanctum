  ...
  return (
    <Alert variant="info">
      ...
      <AlertDescription className="gap-3">
        <p>{envConfig.PLATFORM_NAME} requires two database users to be created for rotation.</p>
        <p>
          These users are intended to be solely managed by {envConfig.PLATFORM_NAME}. Altering their login after
