  ...
  return (
    <div>
      <p className="mb-4 text-sm text-mineshaft-200">
        Reconciliation ensures the password stored in {envConfig.PLATFORM_NAME} matches the actual password on the
        server.
      </p>
  ...
  return (
    <Modal isOpen={isOpen} onOpenChange={onOpenChange}>
      <ModalContent
        ...
        subTitle={`Sync the ${rotationTypeName} password between ${envConfig.PLATFORM_NAME} and the server.`}
      >
        <Content
          secretRotation={
            secretRotation as
