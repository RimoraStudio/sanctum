...
import { SanctumProjectTemplate, useListProjectTemplates } from "@app/hooks/api/projectTemplates";
...
const NewProjectForm = ({ onOpenChange, projectType: fixedProjectType }: NewProjectFormProps) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      template: SanctumProjectTemplate.Default,
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-4">
                      ...
                      <Field>
                        ...
                        >
                          <SelectTrigger id="new-project-template" className="w-full">
                            <SelectValue placeholder={SanctumProjectTemplate.Default} />
                          </SelectTrigger>
                          <SelectContent position="popper">
                            {projectTemplates.length
                              ...
                              : Object.values(SanctumProjectTemplate).map((template) => (
                  ...
                  <Field>
                    ...
                    >
                      <SelectTrigger id="new-project-kms" className="w-full">
                        <SelectValue placeholder={`Default ${envConfig.PLATFORM_NAME} KMS`} />
                      </SelectTrigger>
                      <SelectContent position="popper">
                        <SelectItem value={INTERNAL_KMS_KEY_ID} key="kms-internal">
                          Default {envConfig.PLATFORM_NAME} KMS
                        </SelectItem>
      ...
      <UpgradePlanModal
        ...
        text={`Your current plan does not include access to external KMS. To unlock this feature, please upgrade to ${envConfig.PLATFORM_NAME} Enterprise plan.`}
