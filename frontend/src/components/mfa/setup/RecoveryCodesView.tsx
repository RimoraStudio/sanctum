...
export const RecoveryCodesView = ({ recoveryCodes, onSaved, acknowledgment }: Props) => {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `sanctum-recovery-codes-${new Date().toISOString().split("T")[0]}.txt`;
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="rounded-lg border border-border bg-container p-4">
        <div className="grid grid-cols-1 gap-x-6 gap-y-2 font-mono text-sm sm:grid-cols-2">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <Button variant="neutral" isFullWidth onClick={handleDownload}>
