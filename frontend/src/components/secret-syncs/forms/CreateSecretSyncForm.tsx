  ...
  return [
    {
      ...
      subtitle: `Pick the ${envConfig.PLATFORM_NAME} environment and path to sync from.`,
      rightLabel: "SOURCE",
      rightDescription:
    ...
    },
    {
      ...
      rightDescription: `Tell ${envConfig.PLATFORM_NAME} where to write. Pick a ${destinationName} connection and the exact destination, like a workspace, project, namespace, or whatever this provider expects.`,
    ...
    },
    {
      ...
      subtitle: `Choose how ${envConfig.PLATFORM_NAME} should reconcile existing secrets in ${destinationName} the first time this sync runs.`,
      rightLabel: "INITIAL SYNC",
      rightDescription:
        `The first run is special. ${envConfig.PLATFORM_NAME} can either overwrite everything in the destination or import existing secrets back into ${envConfig.PLATFORM_NAME}. Subsequent runs follow your sync options.`,
      fields: ["syncOptions"]
    },
    {
      name: "Sync Options",
      ...
      rightDescription:
        `Decide how ${envConfig.PLATFORM_NAME} reconciles changes on every run, including auto-sync, key schema, and how conflicts are handled.`,
      fields: ["syncOptions"]
    },
    {
      name: "Details",
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription asChild>
              <div className="flex flex-col gap-2">
                <p>{envConfig.PLATFORM_NAME} is the source of truth for synced destinations.</p>
                <p>
                ...
                {willDeleteUnmatchedSecrets && (
                  <p>
                    Secrets in {destinationName} that don&apos;t exist in {envConfig.PLATFORM_NAME} will be deleted.
                  </p>
                )}
              </div>
            </AlertDialogDescription>
