          ...
          <Field className="mb-4">
            <Field orientation="horizontal">
              <FieldContent>
                ...
                <FieldDescription>
                  When enabled, {envConfig.PLATFORM_NAME} will also sync plaintext and JSON variable bindings in
                  addition to secret bindings. {envConfig.PLATFORM_NAME} can only update existing plaintext and JSON
      ...
      {syncNonSecretBindings && !disableSecretDeletion && (
        <Alert variant="warning" className="mb-4">
          ...
          <AlertDescription>
            ...
            JSON variables in Cloudflare Workers that are not present in {envConfig.PLATFORM_NAME} will be removed
