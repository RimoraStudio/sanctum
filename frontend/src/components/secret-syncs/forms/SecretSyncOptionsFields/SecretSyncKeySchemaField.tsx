  ...
  return (
    <div className="grid grid-cols-[1fr_auto_1fr] items-end gap-3" aria-hidden="true">
      <div className="flex min-w-0 flex-col gap-1">
        <p className="text-[10px] font-medium tracking-wider text-muted uppercase">{envConfig.PLATFORM_NAME}</p>
    ...
    <div className="mb-4">
      <Field orientation="horizontal">
        <FieldContent>
          ...
          <FieldDescription>
            Add a prefix or suffix so {envConfig.PLATFORM_NAME} can identify which keys in {destinationName} it
          ...
          render={({ field: { value, onChange }, fieldState: { error } }) => (
            <Field className="mt-4">
              ...
              <Input
                ...
                value={value ?? ""}
                onChange={onChange}
                placeholder="SANCTUM_{{secretKey}}"
