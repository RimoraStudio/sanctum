                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-lg">
                        <div className="flex flex-col gap-3">
                          <p>
                            Specify how {envConfig.PLATFORM_NAME} should resolve the initial sync to{" "}
            ...
            <Field className="mb-4">
              <Field orientation="horizontal">
                <FieldContent>
                  ...
                  <FieldDescription>
                    When enabled, {envConfig.PLATFORM_NAME} will not remove secrets from {destinationName} during a
