    ...
    <>
      ...
      {writeOnly && !disableSecretDeletion && (
        <Alert variant="warning">
          ...
          <AlertDescription>
            Existing secret values in the Spacelift context cannot be read by {envConfig.PLATFORM_NAME}. Any secret
            values not present in {envConfig.PLATFORM_NAME} will be deleted during sync. Enable secret deletion
