        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <SecretProtectionOption
              ...
              description={`Hides the variable value in the GitLab UI. Requires masking to be enabled. Once enabled, ${envConfig.PLATFORM_NAME} can no longer unhide or unmask the variable from GitLab.`}
              isEnabled={value || false}
              onChange={onChange}
