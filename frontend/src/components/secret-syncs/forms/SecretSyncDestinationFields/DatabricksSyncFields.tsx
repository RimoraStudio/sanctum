            ...
            <FieldLabel>
              ...
              <Tooltip>
                ...
                <TooltipContent className="max-w-md">
                  {envConfig.PLATFORM_NAME} recommends creating a designated Databricks secret scope for your sync
                  to prevent removal of secrets not managed by {envConfig.PLATFORM_NAME}. Ensure that you&apos;ve
