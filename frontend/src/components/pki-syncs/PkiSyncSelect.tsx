  ...
  const handleSelect = (destination: PkiSync, enterprise?: boolean) => {
    if (enterprise && !subscription.enterpriseCertificateSyncs) {
      handlePopUpOpen("upgradePlan", {
        ...
        text: `All Certificate Syncs can be unlocked if you switch to ${envConfig.PLATFORM_NAME} Enterprise plan.`
      });
      return;
    }
    ...
    <div className="flex flex-col gap-6">
      ...
      <p className="text-xs text-muted">
        ...
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://github.com/Sanctum/sanctum/discussions"
          className="underline underline-offset-2 hover:text-foreground"
        >
