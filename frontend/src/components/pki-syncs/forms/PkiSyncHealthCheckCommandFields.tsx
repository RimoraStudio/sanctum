...
export const PkiSyncHealthCheckCommandFields = ({
  ...
  return (
    <HostCommandField
      ...
      description={`Checks the host before ${envConfig.PLATFORM_NAME} writes any certificate. If the command fails, or does not finish within 15 seconds, the sync stops and nothing is delivered. ${envConfig.PLATFORM_NAME} also runs this check once a day, so a broken host surfaces before a renewal reaches it.`}
