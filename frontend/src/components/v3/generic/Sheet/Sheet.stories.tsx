    ...
    <Sheet>
      ...
      <SheetContent side="top">
        <SheetHeader>
          ...
          <SheetDescription>
            {envConfig.PLATFORM_NAME} will be briefly unavailable on Saturday at 02:00 UTC for a database upgrade.
          </SheetDescription>
        </SheetHeader>
        <SheetFooter>
          <SheetClose asChild>
      ...
      <SheetContent>
        ...
        <div className="flex flex-col gap-4 p-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input id="sheet-email" type="email" defaultValue="scott@sanctum.com" />
          </div>
          <div className="flex flex-col gap-2">
          ...
          {Array.from({ length: 12 }).map((_, i) => (
            ...
            <div key={i} className="flex flex-col gap-1 border-b border-border pb-3">
              ...
              <span className="text-accent">
                Secret value updated by scott@sanctum.com — {i + 1}h ago.
              </span>
            </div>
          ))}
        </div>
