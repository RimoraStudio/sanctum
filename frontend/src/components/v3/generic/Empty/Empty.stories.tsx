  ...
  render: (args) => (
    <Empty {...args}>
      <EmptyHeader>
        ...
        <EmptyDescription>
          Access tokens let machines authenticate with the {envConfig.PLATFORM_NAME} API. Generate one to connect a
          client.
        </EmptyDescription>
      </EmptyHeader>
      <EmptyContent>
      ...
      <CardContent>
        <Empty className="border">
          <EmptyHeader>
            ...
            <EmptyTitle>No active access tokens</EmptyTitle>
            <EmptyDescription>
              Access tokens let machines authenticate with the {envConfig.PLATFORM_NAME} API. Generate one to
              connect a client.
            </EmptyDescription>
          </EmptyHeader>
          <EmptyContent>
