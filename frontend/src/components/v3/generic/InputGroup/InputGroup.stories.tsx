...
export const AddonInlineEnd: Story = {
  ...
  render: () => (
    <InputGroup>
      <InputGroupInput type="email" placeholder="you@sanctum.com" />
...
export const WithText: Story = {
  ...
  render: () => (
    <InputGroup>
      ...
      <InputGroupInput placeholder="acme" />
      <InputGroupAddon align="inline-end">
        <InputGroupText>.sanctum.com</InputGroupText>
      </InputGroupAddon>
    </InputGroup>
  )
};
...
export const WithButton: Story = {
  ...
  render: () => (
    <InputGroup>
      <InputGroupInput defaultValue="https://app.sanctum.com/share/abc123" readOnly />
      <InputGroupAddon align="inline-end">
