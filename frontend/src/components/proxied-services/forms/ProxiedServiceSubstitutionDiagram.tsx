    ...
    <div className="rounded-md border border-border bg-container/40 p-3">
      <div className="mb-2.5 flex items-center gap-1.5">
        ...
        <Tooltip>
          ...
          <TooltipContent className="max-w-xs">
            ...
            <span className="font-mono">sanctum secrets agent-proxy connect</span>, {envConfig.PLATFORM_NAME} sets
      ...
      <Node icon={<BotIcon className="size-3.5 text-bunker-300" />} title="Your Agent">
        ...
        <p className="mt-1 text-[11px] leading-tight text-muted">
          {envConfig.PLATFORM_NAME} sets this env var to a fake, real-looking value.
        </p>
      </Node>
