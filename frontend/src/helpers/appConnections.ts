...
import { ExternalSanctumConnectionMethod } from "@app/hooks/api/appConnections/types/external-sanctum-connection";
...
> = {
  ...
  [AppConnection.ExternalSanctum]: {
    name: envConfig.PLATFORM_NAME,
    image: "Sanctum.png",
    category: "SECRET MANAGER",
    description: `Connect to another ${envConfig.PLATFORM_NAME} instance.`
  },
