Feature: External CA
  ...
  Scenario Outline: Issue a certificate from an external CA with Cloudflare
    ...
    Given I create a external ACME CA with the following config as ext_ca
      """
      {
        ...
        "accountEmail": "fangpen@sanctum.com",
    ...
    Then I register a new ACME account with email fangpen@sanctum.com and EAB key id "{acme_profile.eab_kid}" with secret "{acme_profile.eab_secret}" as acme_account
  ...
  Scenario Outline: Issue a certificate with bad CSR names disallowed by the policy
    ...
    Examples:
      ...
      | {"COMMON_NAME": "localhost"}   | ["sanctum.com"]              | Invalid CSR: common_name value 'localhost' is not in allowed values list  |
      | {}                             | ["localhost"]                  | Invalid CSR: dns_name SAN value 'localhost' is not in allowed values list |
      | {}                             | ["sanctum.com", "localhost"] | Invalid CSR: dns_name SAN value 'localhost' is not in allowed values list |
      | {"COMMON_NAME": "example.com"} | ["sanctum.com", "localhost"] | Invalid CSR: dns_name SAN value 'localhost' is not in allowed values list |
  ...
  Scenario Outline: Issue a certificate with algorithms disallowed by the policy
    ...
    Examples:
      ...
      | RSA-4096    | SHA512-RSA        | RSA-2048   | SHA512    | Invalid CSR: Key algorithm 'RSA_2048' is not allowed by this policy                                                                              |
      | RSA-4096    | SHA512-RSA        | RSA-3072   | SHA512    | Invalid CSR: Key algorithm 'RSA_3072' is not allowed by this policy                                                                              |
      | RSA-4096    | ECDSA-SHA512      | ECDSA-P256 | SHA512    | Invalid CSR: Key algorithm 'EC_prime256v1' is not allowed by this policy                                                                         |
      | RSA-4096    | ECDSA-SHA512      | ECDSA-P384 | SHA512    | Invalid CSR: Key algorithm 'EC_secp384r1' is not allowed by this policy                                                                          |
      | RSA-4096    | ECDSA-SHA512      | ECDSA-P521 | SHA512    | Invalid CSR: Key algorithm 'EC_secp521r1' is not allowed by this policy                                                                          |
      | RSA-2048    | SHA512-RSA        | RSA-2048   | SHA384    | Invalid CSR: Signature algorithm 'RSA-SHA384' is not allowed by this policy                                                                      |
      | RSA-2048    | SHA512-RSA        | RSA-2048   | SHA256    | Invalid CSR: Signature algorithm 'RSA-SHA256' is not allowed by this policy                                                                      |
      | ECDSA-P256  | SHA512-RSA        | ECDSA-P256 | SHA256    | Invalid CSR: Signature algorithm 'ECDSA-SHA256' is not allowed by this policy                                                                    |
      | ECDSA-P384  | SHA512-RSA        | ECDSA-P384 | SHA256    | Invalid CSR: Signature algorithm 'ECDSA-SHA256' is not allowed by this policy                                                                    |
      | ECDSA-P521  | SHA512-RSA        | ECDSA-P521 | SHA256    | Invalid CSR: Signature algorithm 'ECDSA-SHA256' is not allowed by this policy                                                                    |
      | RSA-2048    | SHA512-RSA        | RSA-2048   | SHA256    | Invalid CSR: Signature algorithm 'RSA-SHA256' is not allowed by this policy                                                                      |
      | RSA-2048    | SHA512-RSA        | RSA-4096   | SHA256    | Invalid CSR: Signature algorithm 'RSA-SHA256' is not allowed by this policy, Key algorithm 'RSA_4096' is not allowed by this policy |
