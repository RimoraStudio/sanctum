...
const createOracleSanctumUsers = async (
...
const createMySQLSanctumUsers = async (
  credentials: TGenericSqlCredentials,
  userCredentials: TDatabaseUserCredentials[]
) => {
  const client = knex({
...
const createPostgresSanctumUsers = async (
  credentials: TGenericSqlCredentials,
  userCredentials: TDatabaseUserCredentials[]
) => {
  const client = knex({
...
const createOracleDBSecretRotation = async (
  ...
  await createOracleSanctumUsers(credentials, userCredentials);
...
const createMySQLSecretRotation = async (
  ...
  await createMySQLSanctumUsers(credentials, userCredentials);
...
const createPostgresSecretRotation = async (
  ...
  await createPostgresSanctumUsers(credentials, userCredentials);
...
describe("Secret Rotations", async () => {
  const testCases = [
    ...
    },
    {
      ...
      userCredentials: [
        {
          username: formatSqlUsername("SANCTUM_USER_1")
        },
        {
          username: formatSqlUsername("SANCTUM_USER_2")
        }
      ]
    },
    // {
