...
export const createGatewayConnection = async (
  ...
  const protocolToAlpn: Record<string, string[]> = {
    [GatewayProxyProtocol.Http]: ["sanctum-http-proxy"],
    [GatewayProxyProtocol.Tcp]: ["sanctum-tcp-proxy"],
    [GatewayProxyProtocol.Ping]: ["sanctum-ping"],
    [GatewayProxyProtocol.Health]: ["sanctum-health", "sanctum-ping"],
    [GatewayProxyProtocol.Pam]: ["sanctum-pam-proxy"],
    [GatewayProxyProtocol.PamRdpBrowser]: ["sanctum-pam-rdp-browser"],
    [GatewayProxyProtocol.PamSessionCancellation]: ["sanctum-pam-session-cancellation"],
    [GatewayProxyProtocol.Pkcs11]: ["sanctum-pkcs11"],
    [GatewayProxyProtocol.Adcs]: ["sanctum-adcs"],
    [GatewayProxyProtocol.Discovery]: ["sanctum-discovery"],
    [GatewayProxyProtocol.ConnectionTest]: ["sanctum-connection-test"],
    [GatewayProxyProtocol.WinRm]: ["sanctum-winrm"]
  };
