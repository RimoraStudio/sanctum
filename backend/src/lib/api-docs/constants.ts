...
export const ALICLOUD_AUTH = {
  ...
  ATTACH: {
    identityId: "The ID of the machine identity to attach the configuration onto.",
    allowedArns: "The comma-separated list of trusted ARNs that are allowed to authenticate with Sanctum.",
    accessTokenTTL: "The lifetime for an access token in seconds.",
    accessTokenMaxTTL: "The maximum lifetime for an access token in seconds.",
    accessTokenNumUsesLimit: "The maximum number of times that an access token can be used.",
    accessTokenTrustedIps: "The IPs or CIDR ranges that access tokens can be used from."
...
export const TLS_CERT_AUTH = {
  ...
  ATTACH: {
    identityId: "The ID of the machine identity to attach the configuration onto.",
    allowedCommonNames:
      "The comma-separated list of trusted common names that are allowed to authenticate with Sanctum.",
    allowedSubjectAltNames:
      "The comma-separated list of trusted subject alternative names that are allowed to authenticate with Sanctum. Prefix entries by type (URI:, DNS:, IP:, EMAIL:). Bare entries are treated as DNS names.",
...
export const AWS_AUTH = {
  ...
  ATTACH: {
    ...
    allowedPrincipalArns:
      "The comma-separated list of trusted IAM principal ARNs that are allowed to authenticate with Sanctum.",
    allowedAccountIds:
      "The comma-separated list of trusted AWS account IDs that are allowed to authenticate with Sanctum.",
    accessTokenTTL: "The lifetime for an access token in seconds.",
    accessTokenMaxTTL: "The maximum lifetime for an access token in seconds.",
  ...
  UPDATE: {
    identityId: "The ID of the machine identity to update the auth method for.",
    allowedPrincipalArns:
      "The new comma-separated list of trusted IAM principal ARNs that are allowed to authenticate with Sanctum.",
    allowedAccountIds:
      "The new comma-separated list of trusted AWS account IDs that are allowed to authenticate with Sanctum.",
    accessTokenTTL: "The new lifetime for an access token in seconds.",
    accessTokenMaxTTL: "The new maximum lifetime for an access token in seconds.",
...
export const OCI_AUTH = {
  ...
  ATTACH: {
    ...
    allowedUsernames:
      "The comma-separated list of trusted OCI account usernames that are allowed to authenticate with Sanctum.",
    accessTokenTTL: "The lifetime for an access token in seconds.",
    accessTokenMaxTTL: "The maximum lifetime for an access token in seconds.",
    accessTokenNumUsesLimit: "The maximum number of times that an access token can be used.",
    accessTokenTrustedIps: "The IPs or CIDR ranges that access tokens can be used from."
...
export const AZURE_AUTH = {
  ...
  ATTACH: {
    ...
    allowedServicePrincipalIds:
      "The comma-separated list of Azure AD service principal IDs that are allowed to authenticate with Sanctum.",
    accessTokenTrustedIps: "The IPs or CIDR ranges that access tokens can be used from.",
    accessTokenTTL: "The lifetime for an access token in seconds.",
    accessTokenMaxTTL: "The maximum lifetime for an access token in seconds.",
    accessTokenNumUsesLimit: "The maximum number of times that an access token can be used."
  ...
  UPDATE: {
    ...
    allowedServicePrincipalIds:
      "The new comma-separated list of Azure AD service principal IDs that are allowed to authenticate with Sanctum.",
    accessTokenTrustedIps: "The new IPs or CIDR ranges that access tokens can be used from.",
    accessTokenTTL: "The new lifetime for an access token in seconds.",
    accessTokenMaxTTL: "The new maximum lifetime for an access token in seconds.",
    accessTokenNumUsesLimit: "The new maximum number of times that an access token can be used."
...
export const GCP_AUTH = {
  ...
  ATTACH: {
    ...
    allowedServiceAccounts:
      "The comma-separated list of trusted service account emails corresponding to the GCE resource(s) allowed to authenticate with Sanctum.",
    allowedProjects:
      "The comma-separated list of trusted GCP projects that the GCE instance must belong to authenticate with Sanctum.",
    allowedZones:
      "The comma-separated list of trusted zones that the GCE instances must belong to authenticate with Sanctum.",
    accessTokenTrustedIps: "The IPs or CIDR ranges that access tokens can be used from.",
    accessTokenTTL: "The lifetime for an access token in seconds.",
    accessTokenMaxTTL: "The maximum lifetime for an access token in seconds.",
    accessTokenNumUsesLimit: "The maximum number of times that an access token can be used."
  ...
  UPDATE: {
    identityId: "The ID of the machine identity to update the auth method for.",
    allowedServiceAccounts:
      "The new comma-separated list of trusted service account emails corresponding to the GCE resource(s) allowed to authenticate with Sanctum.",
    allowedProjects:
      "The new comma-separated list of trusted GCP projects that the GCE instance must belong to authenticate with Sanctum.",
    allowedZones:
      "The new comma-separated list of trusted zones that the GCE instances must belong to authenticate with Sanctum.",
    accessTokenTrustedIps: "The new IPs or CIDR ranges that access tokens can be used from.",
    accessTokenTTL: "The new lifetime for an access token in seconds.",
    accessTokenMaxTTL: "The new maximum lifetime for an access token in seconds.",
    accessTokenNumUsesLimit: "The new maximum number of times that an access token can be used."
...
export const KUBERNETES_AUTH = {
  ...
  ATTACH: {
    ...
    allowedNamespaces:
      "The comma-separated list of trusted namespaces that service accounts must belong to authenticate with Sanctum.",
    allowedNames: "The comma-separated list of trusted service account names that can authenticate with Sanctum.",
    allowedAudience:
      "The optional audience claim that the service account JWT token must have to authenticate with Sanctum.",
  ...
  UPDATE: {
    ...
    allowedNamespaces:
      "The new comma-separated list of trusted namespaces that service accounts must belong to authenticate with Sanctum.",
    allowedNames: "The new comma-separated list of trusted service account names that can authenticate with Sanctum.",
    allowedAudience:
      "The new optional audience claim that the service account JWT token must have to authenticate with Sanctum.",
    gatewayId: "The ID of the gateway to use when performing kubernetes API requests.",
    accessTokenTrustedIps: "The new IPs or CIDR ranges that access tokens can be used from.",
...
export const DYNAMIC_SECRETS = {
  ...
  DELETE: {
    ...
    name: "The name of the dynamic secret.",
    isForced:
      "A boolean flag to delete the the dynamic secret from Sanctum without trying to remove it from external provider. Used when the dynamic secret got modified externally."
  }
} as const;
...
export const INTEGRATION_AUTH = {
  ...
  CREATE_ACCESS_TOKEN: {
    ...
    awsAssumeIamRoleArn: "The AWS IAM Role to be assumed by Sanctum.",
    url: "",
    namespace: "",
...
export const INTEGRATION = {
  CREATE: {
    ...
    metadata: {
      ...
      shouldMaskSecrets: "Specifies if the secrets synced from Sanctum to Gitlab should be marked as 'Masked'.",
      shouldProtectSecrets: "Specifies if the secrets synced from Sanctum to Gitlab should be marked as 'Protected'.",
...
export const CERTIFICATE_AUTHORITIES = {
  ...
  RENEW_CA_CERT: {
    ...
    type: "The type of behavior to use for the renewal operation. Currently Sanctum is only able to renew a CA certificate with the same key pair.",
...
export const CERTIFICATES = {
  GET: {
    ...
    hasPrivateKey: "Whether Sanctum holds the private key for this certificate.",
  ...
  CONFIGURATIONS: {
    ...
    INTERNAL: {
      ...
      keyAlgorithm:
        "The type of public key algorithm and size, in bits, of the key pair for the CA; when you create an intermediate CA, you must use a key algorithm supported by the parent CA.",
      keySource:
        "Where the CA's signing key is generated and stored. 'sanctum' keeps the key in Sanctum's KMS; 'hsm' generates and stores the key in the HSM reached through the specified HSM Connector.",
      hsmConnectorId:
      ...
      crlDistributionPointUrls:
        "Additional CRL Distribution Point URLs (HTTP/HTTPS) embedded in every certificate issued by this CA. Up to 4 URLs; the Sanctum-managed CRL endpoint is included by default unless disabled.",
      disableManagedCrlDistributionPointUrl:
        "When set to true, the Sanctum-managed CRL endpoint URL will not be embedded in certificates issued by this CA. Only custom CRL Distribution Point URLs (if any) will be included."
    }
  }
};
...
export const AppConnections = {
  ...
  CREATE: (app: AppConnection) => {
    ...
    return {
      ...
      isPlatformManagedCredentials: `Whether or not the ${appName} Connection credentials should be managed by Sanctum. Once enabled this cannot be reversed.`,
...
export const SecretSyncs = {
  ...
  IMPORT_SECRETS: (destination: SecretSync) => ({
    ...
    importBehavior: `Specify whether Sanctum should prioritize secret values from Sanctum or ${SECRET_SYNC_NAME_MAP[destination]}.`
  }),
  ...
  SYNC_OPTIONS: (destination: SecretSync) => {
    const destinationName = SECRET_SYNC_NAME_MAP[destination];
    return {
      initialSyncBehavior: `Specify how Sanctum should resolve the initial sync to the ${destinationName} destination.`,
  ...
  ADDITIONAL_SYNC_OPTIONS: {
    AWS_PARAMETER_STORE: {
      keyId: "The AWS KMS key ID or alias to use when encrypting parameters synced by Sanctum.",
      tags: "Optional resource tags to add to parameters synced by Sanctum.",
      syncSecretMetadataAsTags: `Whether Sanctum secret metadata should be added as resource tags to parameters synced by Sanctum.`
    },
    AWS_SECRETS_MANAGER: {
      keyId: "The AWS KMS key ID or alias to use when encrypting parameters synced by Sanctum.",
      tags: "Optional tags to add to secrets synced by Sanctum.",
      syncSecretMetadataAsTags: `Whether Sanctum secret metadata should be added as tags to secrets synced by Sanctum.`
    },
    RENDER: {
      autoRedeployServices:
        "Whether Sanctum should automatically redeploy the configured Render service upon secret changes."
    },
    FLYIO: {
      autoRedeploy: "Whether Sanctum should automatically redeploy the configured Fly.io app upon secret changes."
    },
    TRIGGER_DEV: {
      markAsSecret:
    ...
    AZURE_KEY_VAULT: {
      disableCertificateImport:
        "Whether Sanctum should skip importing certificate objects from Azure Key Vault when syncing secrets."
    },
    CLOUDFLARE_WORKERS: {
      syncNonSecretBindings:
        "Whether Sanctum should also sync plaintext and JSON variable bindings in addition to secret bindings."
    },
    SPACELIFT: {
      writeOnly:
  ...
  DESTINATION_CONFIG: {
    ...
    AWS_SECRETS_MANAGER: {
      region: "The AWS region to sync secrets to.",
      mappingBehavior: "How secrets from Sanctum should be mapped to AWS Secrets Manager; one-to-one or many-to-one.",
    ...
    EXTERNAL_SANCTUM: {
      projectId: "The ID of the project on the external Sanctum instance to sync secrets to.",
      environment: "The environment slug on the external Sanctum instance to sync secrets to.",
      secretPath: "The secret path on the external Sanctum instance to sync secrets to."
    },
    TRAVIS_CI: {
...
export const SecretRotations = {
  ...
  PARAMETERS: {
    ...
    LITELLM_API_KEY: {
      name: "The name for the generated LiteLLM API key. Sanctum appends a timestamp to keep each rotated key unique and record its creation time.",
      ...
      additionalOptions:
        "A JSON object of additional LiteLLM /key/generate options (e.g. max_budget, tpm_limit, metadata). Reserved fields (key_alias, auto_rotate, rotation_interval, duration, send_invite_email, key_type, user_id, team_id, models) are managed by Sanctum or set via dedicated fields and cannot be set here."
    },
...
export const SamlSso = {
  ...
  UPDATE_CONFIG: {
    ...
    enableGroupSync:
      "Whether to enable automatic synchronization of group memberships from the SAML provider to Sanctum groups."
  },
  CREATE_CONFIG: {
...
export const LdapSso = {
  ...
  CREATE_CONFIG: {
    ...
    bindDN:
      "The distinguished name of the object to bind when performing the user search such as `cn=sanctum,ou=Users,dc=acme,dc=com`",
  ...
  UPDATE_CONFIG: {
    ...
    url: "The LDAP server to connect to such as `ldap://ldap.your-org.com`, `ldaps://ldap.myorg.com:636` (for connection over SSL/TLS), etc.",
    bindDN:
      "The distinguished name of object to bind when performing the user search such as `cn=sanctum,ou=Users,dc=acme,dc=com`",
    bindPass: "The password to use along with Bind DN when performing the user search.",
    uniqueUserAttribute:
      "The attribute to use as the unique identifier of LDAP users such as `sAMAccountName`, `cn`, `uid`, `objectGUID`. If left blank, defaults to uidNumber",
    searchFilter:
...
export const SECRET_SHARING = {
  ...
  CREATE: {
    ...
    allowExternalEmails:
      "When true, allows sharing with email addresses that do not belong to Sanctum. A password is required when this option is enabled. External recipients will receive the secret link via email and must enter the password to access it."
  },
  DELETE: {
...
export const GATEWAYS = {
  ...
  AUTH_METHOD: {
    ...
    allowedAccountIds:
      "The comma-separated list of trusted AWS account IDs that are allowed to authenticate with Sanctum.",
    kubernetesHost:
      "The URL of the Kubernetes API server that Sanctum reviews the gateway's service account token against (e.g. https://my-cluster.example.com:6443). Omit only when tokenReviewMode is 'gateway', where the reviewing gateway calls its own API server.",
    tokenReviewMode:
      "Who performs the TokenReview. 'api' means Sanctum does, using the configured token reviewer JWT. 'gateway' means the selected gateway does, using its own in-cluster service account, which requires no Kubernetes host or reviewer token but requires that gateway to run as a pod in the cluster.",
    gatewayId:
      "The gateway to route TokenReview traffic through, for clusters whose API server Sanctum cannot reach. Must be a different gateway that is already enrolled and connected. Mutually exclusive with gatewayPoolId.",
    gatewayPoolId:
