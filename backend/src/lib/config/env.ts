...
const envSchema = z
  .object({
    SANCTUM_PLATFORM_VERSION: zpStr(z.string().optional()),
    ...
    SMTP_FROM_NAME: zpStr(z.string().optional().default("Sanctum")),
    ...
    SECRET_SCANNING_GIT_APP_SLUG: zpStr(z.string().default("sanctum-radar")),
    SECRET_SCANNING_SCAN_TIMEOUT_MS: z.coerce
      .number()
      .int()
      .min(1)
      .default(10 * 60 * 1000)
      .describe("Wall-clock ceiling for a single `sanctum scan` invocation before its process group is killed"),
    ...
    LICENSE_SERVER_URL: zpStr(z.string().optional().default("https://portal.sanctum.com")),
    ...
    STANDALONE_MODE: z
      ...
      .optional(),
    SANCTUM_CLOUD: zodStrBool.default("false"),
    SANCTUM_DEDICATED: zodStrBool.default("false"),
    ...
    PLATFORM_NAME: zpStr(z.string().optional().default("Sanctum")),
    ...
    SANCTUM_PRIMARY_INSTANCE_URL: zpStr(z.string().optional()),
    ...
    /* Gateway----------------------------------------------------------------------------- */
    GATEWAY_SANCTUM_STATIC_IP_ADDRESS: zpStr(z.string().optional()),
    ...
    DATADOG_SERVICE: zpStr(z.string().optional().default("sanctum-core")),
  ...
  .transform((data) => ({
    ...
    isSecondaryInstance: Boolean(data.SANCTUM_PRIMARY_INSTANCE_URL),
    isHsmConfigured:
...
export const getTelemetryConfig = () => {
  ...
  return {
    ...
    TRACER: {
      ...
      version: parsedEnv.data.SANCTUM_PLATFORM_VERSION,
