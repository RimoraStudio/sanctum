...
export const resourceAuthMethodServiceFactory = ({
  ...
  // Picks the route to the API server: straight out from Sanctum, or tunnelled through a gateway.
  ...
  // Sanctum dials it directly, since a proxied address is resolved inside the customer network.
