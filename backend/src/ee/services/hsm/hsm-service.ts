...
export const hsmServiceFactory = ({ hsmModule: { isInitialized, pkcs11 }, envConfig }: THsmServiceFactoryDep) => {
  ...
  // We test the core functionality of the PKCS#11 module that we are using throughout Sanctum. This is to ensure that the user doesn't configure a faulty or unsupported HSM device.
