...
import { registerExternalSanctumConnectionRouter } from "./external-sanctum-connection-router";
...
export const APP_CONNECTION_REGISTER_ROUTER_MAP: Record<AppConnection, (server: FastifyZodProvider) => Promise<void>> =
  {
    ...
    [AppConnection.ExternalSanctum]: registerExternalSanctumConnectionRouter,
