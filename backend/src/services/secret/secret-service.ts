...
export const secretServiceFactory = ({
  ...
  const getSecretByName = async ({
    ...
    // Case: The old python SDK uses incorrect logic https://github.com/Sanctum/sanctum-python/blob/main/sanctum/client/sanctumclient.py#L89.
    ...
    // Mongo backend check: https://github.com/Sanctum/sanctum-mongo/blob/main/backend/src/helpers/secrets.ts#L658
    let secretType = type;
