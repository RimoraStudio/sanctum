...
export const SANCTUM_SECRET_VALUE_HIDDEN_MASK = "<hidden-by-sanctum>";
...
export const decryptSecretRaw = (
  ...
  const secretValue = !secret.secretValueHidden
    ...
    : SANCTUM_SECRET_VALUE_HIDDEN_MASK;
...
export const conditionallyHideSecretValue = (
  ...
  return {
    secretValueCiphertext: shouldHideValue ? SANCTUM_SECRET_VALUE_HIDDEN_MASK : secretValueCiphertext,
    secretValueIV: shouldHideValue ? SANCTUM_SECRET_VALUE_HIDDEN_MASK : secretValueIV,
    secretValueTag: shouldHideValue ? SANCTUM_SECRET_VALUE_HIDDEN_MASK : secretValueTag,
