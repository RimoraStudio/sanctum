    ...
    try {
      ...
      if (appCfg.OTEL_TELEMETRY_COLLECTION_ENABLED) {
        authAttemptCounter.add(1, {
          "sanctum.identity.id": identityJwtAuth.identityId,
          "sanctum.identity.name": identity.name,
          "sanctum.organization.id": org.id,
          "sanctum.organization.name": org.name,
          "sanctum.identity.auth_method": AuthAttemptAuthMethod.JWT_AUTH,
      ...
      recordAuthAttemptMetric({
        ...
        method: AuthAttemptAuthMethod.JWT_AUTH,
