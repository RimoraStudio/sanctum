...
export const EmailChangeRequestNotificationTemplate = ({
  ...
  return (
    <BaseEmailWrapper
      title="Confirm your Sanctum email change"
      preview="Confirm the email change requested on your Sanctum account."
      siteUrl={siteUrl}
    >
      ...
      <Section className="px-[24px] mt-[36px] pt-[12px] pb-[8px] text-[14px] border border-solid border-gray-200 rounded-md bg-gray-50">
        <Text className="text-[14px]">A request was made to change the email on your Sanctum account.</Text>
...
EmailChangeRequestNotificationTemplate.PreviewProps = {
  currentEmail: "old@sanctum.com",
  requestedEmail: "new@sanctum.com",
  code: "124356",
  isCloud: true,
