...
export const SignupExistingAccountTemplate = ({
  ...
  return (
    <BaseEmailWrapper
      ...
      preview="You already have an Sanctum account."
      siteUrl={siteUrl}
    >
      ...
      <Section className="px-[24px] mb-[28px] mt-[36px] pt-[12px] pb-[8px] border border-solid border-gray-200 rounded-md bg-gray-50">
        <Text className="text-[14px]">
          We received a sign-up request for your Sanctum account (<strong>{email}</strong>).
        </Text>
        <Text className="text-[14px]">
...
SignupExistingAccountTemplate.PreviewProps = {
  ...
  loginUrl: "https://app.sanctum.com/login",
  resetPasswordUrl: "https://app.sanctum.com/forgot-password",
  isCloud: true,
