  ...
  return (
    <BaseEmailWrapper title={title} preview={summary} siteUrl={siteUrl}>
      ...
      <Section className="text-center mt-[28px] mb-[4px]">
        <BaseButton href={viewUrl}>View in Sanctum</BaseButton>
      </Section>

      <Section className="text-center mt-[4px]">
        <Text className="text-[12px] text-gray-500 m-0 leading-[18px]">
          Triggered by alert <strong className="text-gray-700">{alertName}</strong>
        </Text>
      </Section>
      ...
      <Text className="text-[11px] text-gray-400 text-center leading-[16px] mt-[16px] mb-[0px]">
        ...
        {resourceOwnerKind.toLowerCase()}&apos;s alert settings in Sanctum.
      </Text>
    </BaseEmailWrapper>
  );
};
...
AlertNotificationTemplate.PreviewProps = {
  ...
  severity: "critical",
  viewUrl: "https://sanctum.com/organizations/org-1/access-management?selectedTab=identities",
...
} as AlertNotificationTemplateProps;
