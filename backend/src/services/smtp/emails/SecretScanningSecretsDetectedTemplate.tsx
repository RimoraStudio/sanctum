  ...
  return (
    ...
    >
      <Heading className="text-black text-[18px] leading-[28px] text-center font-normal p-0 mx-0">
        Sanctum has uncovered <strong>{numberOfSecrets}</strong> secret(s)
      ...
      <Section className="px-[24px] mb-[28px] mt-[36px] pt-[8px] pb-[8px] text-[14px] border border-solid border-gray-200 rounded-md bg-gray-50">
        ...
        <Text className="text-[14px]">
          ...
          <BaseLink href={url}>Sanctum Dashboard</BaseLink>.
        </Text>
      </Section>
...
SecretScanningSecretsDetectedTemplate.PreviewProps = {
  authorName: "Jim",
  authorEmail: "jim@sanctum.com",
  resourceName: "my-resource",
  numberOfSecrets: 3,
  url: "https://sanctum.com",
  isDiffScan: true,
