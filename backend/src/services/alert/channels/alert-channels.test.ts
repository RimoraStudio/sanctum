...
const samplePayload = (): TAlertPayload => ({
  alert: {
    ...
    condition: "30d",
    viewUrl: "https://app.sanctum.com/inventory"
  },
  eventKey: "pki.certificate.expiration",
  eventLabel: "Expiration",
  webhookType: "com.sanctum.pki.certificate.expiration",
...
describe("buildWebhookPayload", () => {
  test("wraps the payload in a CloudEvents 1.0 envelope", () => {
    ...
    expect(wh.type).toBe("com.sanctum.pki.certificate.expiration");
...
describe("buildSlackPayload", () => {
  ...
  test("escapes Slack control characters in resource-controlled values", () => {
    ...
    payload.items[0].title = "<https://evil.com|View in Sanctum>";
