...
export const GCP_MANAGED_BY_LABEL_VALUE = "sanctum";
export const GCP_CERTIFICATE_ID_LABEL_KEY = "sanctum-certificate-id";
...
export const GCP_CERTIFICATE_MANAGER_PKI_SYNC_LIST_OPTION = {
  ...
  defaultCertificateNameSchema: "sanctum-{{certificateId}}",
