  ...
  getCertificates: async (
    ...
    switch (pkiSync.destination) {
      case PkiSync.AzureKeyVault: {
        throw new Error(
          "Azure Key Vault does not support importing certificates into Sanctum (private keys cannot be extracted)"
        );
      }
      case PkiSync.AwsCertificateManager: {
        throw new Error(
          "AWS Certificate Manager does not support importing certificates into Sanctum (private keys cannot be extracted)"
        );
      }
      case PkiSync.AwsSecretsManager: {
        throw new Error("AWS Secrets Manager does not support importing certificates into Sanctum");
      }
      case PkiSync.Chef: {
        throw new Error(
          "Chef does not support importing certificates into Sanctum (private keys cannot be extracted securely)"
        );
      }
      case PkiSync.AwsElasticLoadBalancer: {
        throw new Error(
          "AWS Elastic Load Balancer does not support importing certificates into Sanctum (certificates are stored in ACM)"
        );
      }
      case PkiSync.CloudflareCustomCertificate: {
        throw new Error(
          "Cloudflare Custom SSL Certificate does not support importing certificates into Sanctum (private keys cannot be extracted)"
        );
      }
      case PkiSync.NetScaler: {
        throw new Error(
          "NetScaler does not support importing certificates into Sanctum (private keys cannot be extracted)"
        );
      }
      case PkiSync.F5BigIp: {
        throw new Error("F5 BIG-IP does not support importing certificates into Sanctum");
      }
      case PkiSync.KempLoadMaster: {
        throw new Error(
          "Kemp LoadMaster does not support importing certificates into Sanctum (private keys cannot be extracted)"
        );
      }
      case PkiSync.LinuxServer: {
        throw new Error("Linux Server does not support importing certificates into Sanctum");
      }
      case PkiSync.WindowsServer: {
        throw new Error("Windows Server does not support importing certificates into Sanctum");
      }
      case PkiSync.NutanixPrismCentral: {
        throw new Error(
          "Nutanix Prism Central does not support importing certificates into Sanctum (private keys cannot be extracted)"
        );
      }
      case PkiSync.GcpCertificateManager: {
        throw new Error(
          "GCP Certificate Manager does not support importing certificates into Sanctum (private keys cannot be extracted)"
        );
      }
      default:
