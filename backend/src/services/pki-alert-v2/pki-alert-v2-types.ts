...
export enum PkiWebhookEventType {
  CERTIFICATE_EXPIRATION = "com.sanctum.pki.certificate.expiration",
  CERTIFICATE_ISSUANCE = "com.sanctum.pki.certificate.issuance",
  CERTIFICATE_RENEWAL = "com.sanctum.pki.certificate.renewal",
  CERTIFICATE_REVOCATION = "com.sanctum.pki.certificate.revocation",
  CERTIFICATE_TEST = "com.sanctum.pki.certificate.test"
}
