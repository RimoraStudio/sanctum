  ...
  if (oracledb.thin) {
    try {
      ...
      throw new BadRequestError({
        message: `Failed to initialize Oracle client: ${errorMessage}. See documentation for instructions: https://sanctum.com/docs/integrations/app-connections/oracledb#mutual-tls-wallet`
      });
    }
  }
  return knex({
