...
import {
  ...
  getExternalSanctumConnectionListItem,
  TExternalSanctumConnectionConfig,
  validateExternalSanctumConnectionCredentials
} from "./external-sanctum";
import {
...
export const validateAppConnectionCredentials = async (
  ...
  const VALIDATE_APP_CONNECTION_CREDENTIALS_MAP: Record<AppConnection, TAppConnectionCredentialsValidator> = {
    ...
    [AppConnection.ExternalSanctum]: ((config: TAppConnectionConfig) =>
      validateExternalSanctumConnectionCredentials(
        config as TExternalSanctumConnectionConfig,
        deps.identityUaDAL
      )) as TAppConnectionCredentialsValidator,
...
export const getAppConnectionMethodName = (method: TAppConnection["method"]) => {
  switch (method) {
    ...
    case NutanixPrismCentralConnectionMethod.BasicAuth:
      return "Basic Auth";
    case ExternalSanctumConnectionMethod.MachineIdentityUniversalAuth:
...
> = {
  ...
  [AppConnection.ExternalSanctum]: platformManagedCredentialsNotSupported,
