...
export const NATIVE_INTEGRATION_DEPRECATION_MESSAGE =
  ...
  `Use Secret Syncs instead: https://sanctum.com/docs/integrations/secret-syncs/native-integrations-migration. ` +
  `If the service you need isn't available as a Secret Sync, contact team@sanctum.com. ` +
