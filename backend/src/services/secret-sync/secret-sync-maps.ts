...
export const SECRET_SYNC_NAME_MAP: Record<SecretSync, string> = {
  ...
  [SecretSync.ExternalSanctum]: "Sanctum",
  [SecretSync.OVH]: "OVH",
...
export const SECRET_SYNC_PLAN_MAP: Record<SecretSync, SecretSyncPlanType> = {
  ...
  [SecretSync.ExternalSanctum]: SecretSyncPlanType.Regular,
...
export const DESTINATION_DUPLICATE_CHECK_MAP: Record<SecretSync, DestinationDuplicateCheckFn> = {
  ...
  [SecretSync.ExternalSanctum]: defaultDuplicateCheck,
 ...
 */
export const SECRET_SYNC_DAILY_RETRY_DESTINATIONS = new Set<SecretSync>([SecretSync.ExternalSanctum]);
