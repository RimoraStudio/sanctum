...
const AzureEntraIdScimSyncOptionsReadSchema = z.object({
  secretId: z
    ...
    .uuid()
    .optional()
    .describe("The ID of the Sanctum secret whose value will be used as the SCIM provisioning token.")
});
...
const AzureEntraIdScimSyncOptionsInputSchema = z.object({
  secretKey: z
    ...
    .describe("The key of the Sanctum secret whose value will be used as the SCIM provisioning token.")
});
